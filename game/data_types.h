...
#define INVENTORY_SLOTS 10 // Slots de Inventario
...
typedef struct {
    ...
    char* name;         // Nombre del Item
    int type;           // Tipo del item (1. Consumible, 2. Arma, 3. Armadura)
    char* rarity;       // Rareza del Item (Ilustrativo)
    int damage;         // Daño (Permanente si es Armadura, Temporal si es Pocion)
...
typedef struct ScenarioNode {
    ...
    char* description;          // Descripción breve del lugar
